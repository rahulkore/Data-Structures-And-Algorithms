...
public class InfixToPreFix {
    ...
    public static void main(String[] args) {
		//String infix = "a+b*c";
		String infixString = "m*j-(n+d)/f*w+z";
        StringBuffer sbr = new StringBuffer(infixString);
        sbr.reverse();
        char infix[] = sbr.toString().toCharArray();
        ...
        String post = Stack.convert(String.valueOf(infix));
        sbr = new StringBuffer(post);
        post = sbr.reverse().toString();
